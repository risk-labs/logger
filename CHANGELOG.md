The changelog is copied over from (Uma protocol repo)[https://github.com/UMAprotocol/protocol/blob/master/packages/logger/CHANGELOG.md] for completeness. for `@risk-labs/logger`, `CHANGELOG.md`'s status is TBD.
